...
using kriefTrackAiApi.Core.ProjectAggregate;
using kriefTrackAiApi.Core.Services;
using kriefTrackAiApi.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace kriefTrackAiApi.UnitTests.Core.Services
{
